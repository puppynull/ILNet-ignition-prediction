import torch
import sys
sys.path.append('D:\\code\\新建 WinRAR 压缩文件 (1)\\200101Fire_Spread_Based_on_DL')
from torch import nn, Tensor
from torch.nn import functional as F
from network.layers import DropPath
from network.base.fusion import Fusion
...
class MiT(nn.Module):
    def __init__(self, model_name: str = 'B0'):
        ...
        # self.fusion = Fusion()
        # patch_embed
        self.patch_embed1 = PatchEmbed(4, embed_dims[0], 7, 4)
        # self.patch_embed1 = PatchEmbed(64, embed_dims[0], 7, 4)
...
if __name__ == '__main__':
    ...
    img1 = torch.randn(2, 25, 256, 256)
    img2 = torch.randn(2, 1, 256, 256)
    img3 = torch.randn(2, 2)
    img4 = torch.randn(2, 2)
    img5 = torch.randn(2, 25, 256, 256)
